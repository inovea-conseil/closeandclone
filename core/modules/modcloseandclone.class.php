...
/**
 *  Description and activation class for module closeandclone
 */
class modcloseandclone extends DolibarrModules
{
	/**
	...
	function __construct($db)
	{
		...
		$this->numero = 432435; // !!Code ID du module!!
		// Key text used to identify module (for permissions, menus, etc...)
		$this->rights_class = 'closeandclone';
		...
		$this->picto='closeandclone@closeandclone';
        ...
        //    'js'  => array('/closeandclone/js/closeandclone.js'),
		...
		$this->langfiles = array("closeandclone@closeandclone");
        ...
        // Dictionaries
	    if (! isset($conf->closeandclone->enabled))
        {
        	$conf->closeandclone=new stdClass();
        	$conf->closeandclone->enabled=0;
        }
